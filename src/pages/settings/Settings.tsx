...
import { TempPreference } from 'src/pages/Settings/TempPreference';
import { SpeedPreference } from 'src/pages/Settings/SpeedPreference';
import { TimePreference } from 'src/pages/Settings/TimePreference';
