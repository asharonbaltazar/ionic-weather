...
export const AddressAndGeolocation = ({
  ...
  return (
    <div className="flex grow items-center lg:col-start-2 lg:bg-white lg:p-3 lg:shadow-sm lg:dark:bg-stone-900 lg:dark:shadow-none">
      <span className="flex grow items-center justify-center gap-x-2 pl-5 lg:justify-start lg:pl-0">
