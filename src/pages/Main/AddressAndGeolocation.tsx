...
export const AddressAndGeolocation = ({
  ...
  return (
    <div className="flex grow items-center justify-center gap-x-2 rounded-l-lg lg:col-start-2 lg:block lg:bg-white lg:p-3 lg:shadow-sm lg:dark:bg-stone-900 lg:dark:shadow-none">
